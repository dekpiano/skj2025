...
<style>
    ...
    .scanner-line {
        width: 100%;
        height: 4px;
        background: linear-gradient(90deg, rgba(26, 35, 126, 0) 0%, rgba(26, 35, 126, 0.8) 50%, rgba(26, 35, 126, 0) 100%);
        box-shadow: 0 0 10px #1a237e, 0 0 20px #003366;
        position: absolute;
        top: 0;
        left: 0;
    ...
    <div class="attendance-container">
        ...
        <div class="attendance-hero mb-4 text-center text-md-start">
            <div class="row align-items-center">
                <div class="col-md-7">
                    <span class="badge bg-opacity-20 mb-2 px-3 py-2 text-white"><i class="bi bi-clock-history me-1"></i> SKJ Check-In</span>
                ...
                <div class="col-md-5 text-md-end mt-4 mt-md-0">
                    <div class="text-white text-opacity-75 small mb-1">สถานะการลงเวลาวันนี้ (ผู้บริหาร)</div>
                    <div>
                        <?php if ($status === 'none'): ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-6 order-1">
                <div class="camera-card text-center shadow-sm">
                    ...
                    <div class="d-grid gap-2">
                        <button type="button" id="btn-start-camera" class="btn btn-primary btn-camera-action py-3">
            ...
            <div class="col-12 col-lg-6 order-2">
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <a href="<?= base_url('Manager/ManagerAttendance/History') ?>" class="btn btn-outline-primary w-100 py-2 d-flex align-items-center justify-content-center gap-1" style="border-radius: 10px;">
                            <i class="bi bi-clock-history"></i> ดูประวัติ
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?= base_url('Manager/ManagerAttendance/Report') ?>" class="btn btn-outline-info w-100 py-2 d-flex align-items-center justify-content-center gap-1" style="border-radius: 10px;">
...
<script>
    ...
    function submitAttendance(type) {
        ...
        const url = type === 'checkin'
            ? '<?= base_url('Manager/ManagerAttendance/checkin') ?>'
            : '<?= base_url('Manager/ManagerAttendance/checkout') ?>';
