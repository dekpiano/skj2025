...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <h4 class="mb-1 fw-bold"><i class="bi bi-graph-up me-2 text-primary"></i>รายงานสรุปรายเดือนผู้บริหาร</h4>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow-sm border">
                <div class="card-body">
                    <form method="get" action="<?= base_url('Manager/ManagerAttendance/Report') ?>" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            <a href="<?= base_url('Manager/ManagerAttendance/History?month=' . $month . '&year=' . $year) ?>" class="btn btn-outline-info w-100">
    ...
    <!-- Report Title -->
    <div class="alert alert-primary d-flex align-items-center mb-4 border-0" role="alert" style="background-color: rgba(0, 51, 102, 0.1); color: #003366;">
