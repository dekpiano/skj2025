                    ...
                    <div class="login-btn-wrap">
                        <div class="has-dropdown">
                            ...
                            <ul class="sub-menu sub-menu-right">
                                ...
                                <li><a href="<?= base_url('SkjMain/googleLogin') ?>"><img src="https://www.gstatic.com/images/branding/product/1x/gsa_512dp.png" alt="Google" width="15" height="15" class="me-2">สำหรับผู้ดูแลระบบ (Admin)</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="mobile-header d-flex d-lg-none align-items-center justify-content-between py-2 px-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <button class="navbar-toggler-lawa" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#mobileMenuOffcanvas" aria-controls="mobileMenuOffcanvas" aria-label="Toggle navigation">
...
<!-- =========================================================================
     ...
     ========================================================================= -->
<div class="offcanvas offcanvas-end mobile-offcanvas d-lg-none" tabindex="-1" id="mobileMenuOffcanvas" aria-labelledby="mobileMenuOffcanvasLabel">
    <!-- Offcanvas Header -->
    <div class="offcanvas-header mobile-offcanvas-header">
        <div class="d-flex align-items-center gap-2">
            <img src="<?= base_url() ?>/assets/img/logo/Logo-nav.png" alt="SKJ" height="38">
            <div>
                <h6 class="offcanvas-title fw-bold text-white mb-0" id="mobileMenuOffcanvasLabel">เมนูหลัก (SKJ Menu)</h6>
        ...
        <ul class="mobile-nav-menu">
            ...
            <li class="mob-dropdown">
                ...
                <ul class="mob-sub">
                    ...
                    <?php endforeach; ?>
                    <li><a href="<?= base_url('Board') ?>"><i class="bi bi-person-lines-fill me-2"></i>คณะกรรมการสถานศึกษา</a></li>
                    <li><a href="<?= base_url('Botany') ?>"><i class="bi bi-flower1 me-2"></i>งานสวนพฤกษศาสตร์</a></li>
                </ul>
            </li>
            ...
            <li class="mob-dropdown">
                ...
                <ul class="mob-sub">
                    <li><a href="https://student.skj.ac.th/"><i class="bi bi-person-fill me-2"></i>สำหรับนักเรียน</a></li>
                    <li><a href="https://teacher.skj.ac.th/"><i class="bi bi-person-workspace me-2"></i>สำหรับครูผู้สอน</a></li>
                    <li><a href="<?= base_url('Manager/Dashboard') ?>"><i class="bi bi-bar-chart-line-fill me-2"></i>สำหรับผู้บริหาร</a></li>
                    <li><a href="<?= base_url('Support/SupportAttendance') ?>"><i class="bi bi-person-gear me-2"></i>สำหรับฝ่ายสนับสนุน</a></li>
                </ul>
            </li>
            ...
            <li class="mt-4 pt-3 border-top border-white-15">
                ...
                <div class="social-icons-left mobile-social mt-2">
                    <a href="https://www.facebook.com/SKJNS160" target="_blank"><i class="bi bi-facebook"></i></a>
                    <a href="https://youtube.com/channel/UC7p4cQQuIFLyrF68p7JbWDw?si=qOHoQSymoleB3ntP" target="_blank"><i class="bi bi-youtube"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
                </div>

                <!-- Discreet Admin Google Login at the very bottom -->
                <div class="text-center mt-4 pt-2 border-top border-white-10">
                    <a href="<?= base_url('SkjMain/googleLogin') ?>" class="text-decoration-none d-inline-flex align-items-center gap-2 py-1 px-2 rounded" style="font-size: 11px; color: rgba(255, 255, 255, 0.45); background: rgba(0, 0, 0, 0.15); transition: all 0.2s;" onmouseover="this.style.color='rgba(255,255,255,0.95)'; this.style.background='rgba(0,0,0,0.3)';" onmouseout="this.style.color='rgba(255,255,255,0.45)'; this.style.background='rgba(0,0,0,0.15)';">
                        <img src="https://www.gstatic.com/images/branding/product/1x/gsa_512dp.png" alt="Google" width="13" height="13">
...
<nav class="mobile-bottom-nav d-flex d-lg-none" aria-label="แถบเมนูล่าง">
    ...
    <a href="javascript:void(0);" class="bottom-nav-item bottom-nav-highlight" data-bs-toggle="offcanvas" data-bs-target="#mobileServicesSheet" aria-controls="mobileServicesSheet">
    ...
    <a href="javascript:void(0);" class="bottom-nav-item" onclick="if(typeof toggleChatWindow === 'function'){toggleChatWindow();}else{window.location.href='<?= base_url('Contact') ?>';}" title="ช่องแชท">
        <div class="nav-icon-box">
    ...
    <a href="javascript:void(0);" class="bottom-nav-item" data-bs-toggle="offcanvas" data-bs-target="#mobileMenuOffcanvas" aria-controls="mobileMenuOffcanvas">
        <div class="nav-icon-box">
...
<!-- =========================================================================
     ...
     ========================================================================= -->
<div class="offcanvas offcanvas-bottom mobile-sheet-services d-lg-none" tabindex="-1" id="mobileServicesSheet" aria-labelledby="mobileServicesSheetLabel">
    ...
    <div class="offcanvas-header pb-2 pt-2 px-3 border-bottom">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <h6 class="offcanvas-title fw-bold mb-0" id="mobileServicesSheetLabel" style="font-size: 15px;">บริการออนไลน์ (SKJ Services)</h6>
    ...
    <div class="offcanvas-body px-3 py-3" style="overflow-y: auto;">
        ...
        <div class="sheet-category-title"><i class="bi bi-mortarboard-fill text-primary me-1"></i> นักเรียน & การเรียน</div>
        ...
        <div class="sheet-category-title"><i class="bi bi-wrench-adjustable text-warning me-1"></i> ระบบจอง & แจ้งซ่อม</div>
        <div class="services-app-grid mb-3">
        ...
        <div class="services-app-grid mb-3">
            ...
            <a href="<?= base_url('Botany') ?>" class="service-app-card">
...
<style>
   ...
   ================================================================ */
    ...
    .bg-primary-soft { background: rgba(36, 159, 253, 0.2); color: #56ccf2; }
    .bg-pink-soft { background: rgba(251, 126, 156, 0.2); color: #fb7e9c; }
    .bg-blue-soft { background: rgba(2, 132, 199, 0.2); color: #38bdf8; }
    .bg-warning-soft { background: rgba(245, 158, 11, 0.2); color: #fbbf24; }
    .bg-purple-soft { background: rgba(168, 85, 247, 0.2); color: #c084fc; }
    .bg-teal-soft { background: rgba(20, 184, 166, 0.2); color: #2dd4bf; }
    .bg-danger-soft { background: rgba(239, 68, 68, 0.2); color: #f87171; }
    .bg-success-soft { background: rgba(34, 197, 94, 0.2); color: #4ade80; }
    ...
    .mob-sub li a:hover, .mob-sub li a:active {
        color: #fff;
        background: rgba(255, 255, 255, 0.08);
        padding-left: 18px;
    }
    ...
    .bg-pink-grad { background: linear-gradient(135deg, #ff6b8b, #e11d48); }
    .bg-blue-grad { background: linear-gradient(135deg, #38bdf8, #0284c7); }
    .bg-teal-grad { background: linear-gradient(135deg, #2dd4bf, #0f766e); }
    .bg-purple-grad { background: linear-gradient(135deg, #c084fc, #7e22ce); }
    .bg-amber-grad { background: linear-gradient(135deg, #fbbf24, #d97706); }
    .bg-emerald-grad { background: linear-gradient(135deg, #34d399, #059669); }
    .bg-indigo-grad { background: linear-gradient(135deg, #818cf8, #4338ca); }
    .bg-rose-grad { background: linear-gradient(135deg, #fb7185, #be123c); }
</style>
